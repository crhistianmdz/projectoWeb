...
SECRET_KEY = '^!$hc!qo_%rm2gi@1ne3@!(2%5+uy0yu^#y4fgof0$f$91$@vz'
...
TEMPLATES = [
    {
        ...
        'DIRS': [''],#/home/crhistian/Documentos/proyectos propios/djangoTutorial/Projectoweb/ProjectoWebApp/template
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
